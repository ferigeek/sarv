...
| وب‌کلاینت فرانت‌اند (احراز هویت، زبانه‌های فید، پست‌ها، واکنش‌ها، پروفایل‌ها، جست‌وجو، رسانه) | پیاده‌سازی‌شده (تولیدشده با ایجنت هوش مصنوعی؛ محتوای موضوعات/اخبار و بازنشر/نقل‌قول/نظر هنوز نگهدارنده‌اند — به [7-Frontend.md](./7-Frontend.md) مراجعه کنید) |
